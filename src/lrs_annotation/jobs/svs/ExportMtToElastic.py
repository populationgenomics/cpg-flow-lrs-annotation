...
def export_svs_mt_to_elasticsearch(
    batch: Batch,
    mt_path: str,
    index_name: str,
    flag_name: str,
    ...
    """
    Export the annotated SVs mt to ElasticSearch.
    """
    ...
    es_export_job = get_resource_overrides_for_job(es_export_job, 'export_svs_mt_to_elastic')
