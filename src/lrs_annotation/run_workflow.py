...
from lrs_annotation.svs_annotation_stages import ExportSVsMtToElasticIndex, LongTRIndexPage, LongTRPathogenicReport
...
def cli_main():
    ...
    if args.workflow == 'bam_to_cram':
        ...
        stages = [ExportSVsMtToElasticIndex, LongTRPathogenicReport, LongTRIndexPage]
    else:
